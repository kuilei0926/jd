...
$.appid = 'o2_act';
const UA = $.isNode() ? (process.env.JD_USER_AGENT : jdpingou;iPhone;10.0.6;${Math.ceil(Math.random()*2+12)}.${Math.ceil(Math.random()*4)};${randomString(40)};) : ($.getdata('JDUA') ? $.getdata('JDUA') : jdpingou;iPhone;10.0.6;${Math.ceil(Math.random()*2+12)}.${Math.ceil(Math.random()*4)};${randomString(40)};)
